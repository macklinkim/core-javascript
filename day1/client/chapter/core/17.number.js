...
// 여러 수 중, 최댓값
const nArray = [51, 61, 94, 72, 60, 32, 84];
...
function createRandom() {
  ...
  return function (a, b) {
    let c = Math.min(a, b);
    let d = Math.random() * c + c;
    return ++times + " : " + d.toFixed();
  };
}
let getRandomMinMax1 = createRandom();
let getRandomMinMax2 = createRandom();
let getRandomMinMax3 = createRandom();
let getRandomMinMax4 = createRandom();
console.log(getRandomMinMax1(5, 10));
console.log(getRandomMinMax1(5, 10));
console.log(getRandomMinMax1(5, 10));
console.log(getRandomMinMax1(50, 100));
console.log(getRandomMinMax1(50, 100));
console.log(getRandomMinMax1(50, 100));
console.log(getRandomMinMax2(50, 100));
console.log(getRandomMinMax2(50, 100));
console.log(getRandomMinMax2(50, 100));
console.log(getRandomMinMax3(50, 100));
console.log(getRandomMinMax3(50, 100));
console.log(getRandomMinMax3(50, 100));
console.log(getRandomMinMax4(50, 100));
console.log(getRandomMinMax4(50, 100));
console.log(getRandomMinMax4(50, 100));
console.log(getRandomMinMax4(50, 100));
